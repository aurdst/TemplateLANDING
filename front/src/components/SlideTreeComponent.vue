<template>
    <v-container>
        <v-row>
            <v-col cols='12' class="pa-15 text-justify">
                ...
                <v-btn variant="tonal" class="btn">Button</v-btn>
                <v-btn variant="tonal" class="btn">Button</v-btn>
            </v-col>
            <v-col cols='12'>
                <v-img src="@/assets/pexels-expect-best-323705.jpg" width="100vw" height="auto" alt="" />
            </v-col>
        </v-row>
    </v-container>
</template>
